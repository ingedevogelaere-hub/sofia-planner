 ...
 * lib/constants.js
 * ─────────────────────────────────────────────────────────
 * Toutes les constantes globales de l'application Sofia Planner.
 * Contient : palette de couleurs (C), clé Unsplash, listes de choix
 * (styles de voyage, hébergements, budgets, transports, voyageurs),
 * fonctions utilitaires pures (enc, fixDest, getAdults) et styles
 * de boutons réutilisables (selBtn, pillBtn).
 * Importé par la quasi-totalité des autres fichiers.
 */
