 ...
 * lib/links.js
 * ─────────────────────────────────────────────────────────
 * Générateurs d'URL pour les liens externes du plan de voyage.
 * buildLinks() : produit les liens Booking, Airbnb, Hotels.com,
 *   TripAdvisor, TheFork, AllTrails, GetYourGuide, Viator, Google Maps
 *   selon le type de contenu (hébergement, restaurant, sortie, site).
 * buildMapUrl() : construit l'URL Google Maps avec l'itinéraire
 *   complet (mode directions si plusieurs étapes, sinon search).
 */
